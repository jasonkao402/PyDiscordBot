...
import cog_dev.database_test
from cog_dev.database_test import (
    Persona, DiscordUser, ChatInteraction, PersonaMemories, UserGroups,
    PersonaGroupAccess, PersonaVisibility,
    PersonaRepository, DiscordUserRepository, InteractionRepository,
    ChatInteractionRepository, PersonaMemoriesRepository,
    UserGroupsRepository, PersonaGroupAccessRepository,
    PersonaDatabase,
    _split_uid_list, _join_uid_list, _now_iso,
    DB_DEFAULT_PATH
)
...
class BaseTestWithDB(unittest.TestCase):
    ...
    def setUp(self):
        self.db = PersonaDatabase("file:testdb?mode=memory&cache=shared")
